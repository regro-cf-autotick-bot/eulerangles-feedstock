...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eulerangles-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15232&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eulerangles-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eulerangles` can be installed with:

```
conda install eulerangles
```

It is possible to list all of the versions of `eulerangles` available on your platform with:
